    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="./do_addClass.php" method="post" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>                                                   
                            <tr>
                                <th><i class="require-red">*</i>添加类名：</th>
                                <td>
                                    <input class="common-text required" id="classname" name="classname" size="50" type="text">
                                </td>
                            <tr>
                                <th></th>
                                <td>
